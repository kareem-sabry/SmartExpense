...
{
    /// <inheritdoc />
    public partial class Baseline_PostgreSQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshToken = table.Column<string>(type: "character varying(88)", maxLength: 88, nullable: true),
                    PreviousRefreshTokenHash = table.Column<string>(type: "character varying(88)", maxLength: 88, nullable: true),
