...
public class CategoryRepository : GenericRepository<Category>, ICategoryRepository
{
    ...
    public async Task<List<Category>> GetAllForUserAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        return await _dbSet
            .AsNoTracking()
    ...
    /// </summary>
    public async Task<Category?> GetByIdForUserAsync(int id, Guid userId, CancellationToken cancellationToken = default)
    {
        return await _dbSet
            .AsNoTracking()
            .FirstOrDefaultAsync(c => c.Id == id && (c.IsSystemCategory || c.UserId == userId), cancellationToken);
    }
